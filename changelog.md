...
for the operator and Absolute addresses for the owner and voting.
- Main window: the possibility of displaying private keys in the form 
of: Absolute address, public key and public key hash (for diagnostics).
...
in the `protx prepare` call (added in Absolute Core rc11).
...
**Added**
- Support for Absolute v13 - Deterministic Masternode List (protocol 70213)
...
**Added**
- Absolute daemon v12.3 support (protocol 70209/70210)
...
- Moved to the official Trezor Insight API for Absolute (https://absolute-bitcore1.trezor.io/api/).
...
- The connection was incorrectly shown as successful for proxy connections when nginx was running, but the Absolute daemon was not.
