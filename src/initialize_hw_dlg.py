...
import app_cache
import app_defs
from absolute_utils import pubkey_to_address
...
class HwInitializeDlg(QDialog, ui_initialize_hw_dlg.Ui_HwInitializeDlg, WndUtils):
    ...
    def setupUi(self):
        ...
        self.edtHwOptionsBip32Path.setText(absolute_utils.get_default_bip32_path(self.app_config.absolute_network))
    ...
    def refresh_adresses_preview(self):
        if self.mnemonic:
            ...
            bip32_path_n = absolute_utils.bip32_path_string_to_n(bip32_path)
            if len(bip32_path_n) > 0:
                ...
                for idx in range(10):
                    ...
                    addr = pubkey_to_address(pubkey, self.app_config.absolute_network)
...
class PreviewAddressesModel(QAbstractTableModel):
    def __init__(self, parent):
        ...
        self.addresses = []  # list of tuples: bip32 path, absolute address
