...
class HwSessionInfo(QObject):
    ...
    def __init__(self,
                 ...
                 app_config: object,
                 absoluted_intf: object):
        QObject.__init__(self)

        self.__locks = {}  # key: hw_client, value: EnhRLock
        self.__app_config = app_config
        self.__absoluted_intf = absoluted_intf
    ...
    @property
    def absoluted_intf(self):
        return self.__absoluted_intf

    def set_absoluted_intf(self, absoluted_intf):
        self.__absoluted_intf = absoluted_intf
