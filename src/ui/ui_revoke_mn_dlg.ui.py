...
class Ui_RevokeMnDlg(object):
    ...
    def retranslateUi(self, RevokeMnDlg):
        ...
        self.lblDescription.setText(_translate("RevokeMnDlg", "This transaction is used by the operator to terminate service or signal the owner that a new BLS key is required (<a href=\"https://absify.me/support/stable/masternodes/maintenance.html#prouprevtx\">details</a>)."))
