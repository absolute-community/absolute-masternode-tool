...
class Ui_ConfigDlg(object):
    def setupUi(self, ConfigDlg):
        ...
        self.tabAbsoluted = QtWidgets.QWidget()
        self.tabAbsoluted.setObjectName("tabAbsoluted")
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.tabAbsoluted)
        self.verticalLayout_3.setContentsMargins(3, 3, 3, 3)
        self.verticalLayout_3.setSpacing(3)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.label_2 = QtWidgets.QLabel(self.tabAbsoluted)
        self.label_2.setObjectName("label_2")
        self.horizontalLayout_3.addWidget(self.label_2)
        self.cboAbsoluteNetwork = QtWidgets.QComboBox(self.tabAbsoluted)
        self.cboAbsoluteNetwork.setObjectName("cboAbsoluteNetwork")
        self.cboAbsoluteNetwork.addItem("")
        self.cboAbsoluteNetwork.addItem("")
        self.horizontalLayout_3.addWidget(self.cboAbsoluteNetwork)
        spacerItem = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_3.addItem(spacerItem)
        self.verticalLayout_3.addLayout(self.horizontalLayout_3)
        self.frame_2 = QtWidgets.QFrame(self.tabAbsoluted)
        ...
        self.tabWidget.addTab(self.tabAbsoluted, "")
    ...
    def retranslateUi(self, ConfigDlg):
        ...
        self.label_2.setText(_translate("ConfigDlg", "Absolute network:"))
        self.cboAbsoluteNetwork.setItemText(0, _translate("ConfigDlg", "MAINNET"))
        self.cboAbsoluteNetwork.setItemText(1, _translate("ConfigDlg", "TESTNET"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabAbsoluted), _translate("ConfigDlg", "Absolute network"))
        ...
        self.chbDownloadProposalExternalData.setText(_translate("ConfigDlg", "Download external proposal attributes (AbsoluteCentral.org)"))
